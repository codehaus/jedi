...
import jedi.filters.EqualObjectFilter;
...
public class FunctionalPrimitivesTest extends JediTestCase {
    ...
    @Test
    public void testIndexWhereOnEmptyList() {
        assertEquals(-1, indexWhere(Collections.<String>emptyList(), EqualObjectFilter.create("hi")));
    }

    @Test
    public void testIndexWhereOnListWithoutMatchingItem() {
        assertEquals(-1, indexWhere(list("a", "b"), EqualObjectFilter.create("hi")));
    }

    @Test
    public void testIndexWhere() {
        assertEquals(1, indexWhere(list("a", "hi", "c"), EqualObjectFilter.create("hi")));
    }

    @Test
    public void testLastIndexWhereOnEmptyList() {
        assertEquals(-1, lastIndexWhere(Collections.<String>emptyList(), EqualObjectFilter.create("hi")));
    }

    @Test
    public void testLastIndexWhereOnListWithoutMatchingItem() {
        assertEquals(-1, lastIndexWhere(list("a", "b"), EqualObjectFilter.create("hi")));
    }

    @Test
    public void testLastIndexWhere() {
        assertEquals(2, lastIndexWhere(list("a", "hi", "hi", "b"), EqualObjectFilter.create("hi")));
        assertEquals(2, lastIndexWhere(list("a", "b", "hi"), EqualObjectFilter.create("hi")));
        assertEquals(0, lastIndexWhere(list("a", "b", "c"), EqualObjectFilter.create("a")));
    }
    ...
    @Test
    public void testReduceWithEmptyCollection() {
        try {
            reduce(Collections.<Integer>emptyList(), functor2);
            fail();
    ...
    public void testReduce() {
        assertEquals(10, reduce(list(1, 2, 3, 4), summer()).intValue());
    }
    ...
    private Functor2<Integer, Integer, Integer> summer() {
        return new Functor2<Integer, Integer, Integer>() {
