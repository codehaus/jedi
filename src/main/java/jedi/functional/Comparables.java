...
public class Comparables {
	...
	/**
	 * Copy the <code>items</code> into a new list, sort the new list using the
	...
	/**
	 * Copy the <code>items</code> into a new list, sort the new list using the
	 * given <code>comparator</code> and return the new list.
	 */
	 ...
	 * given <code>evaluator</code> to each item and return the new list.
	 */
	...
	/**
	 * Sort <code>items</code> in place using the natural ordering of the
	...
	/**
	 * Sort <code>items</code> in place using the given <code>comparator</code>.
	...
	/**
	 * Sort <code>items</code> in place using the {@link java.lang.Comparable
	 * Comparable} values obtained by applying the given <code>evaluator</code>
