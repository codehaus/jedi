...
import static jedi.functional.Range.range;
...
public class ProjectEuler {
    ...
    public void problemOne() {
        assertEqual(Integer.valueOf(233168),
            fold(0,
                select(
                    range(1, 1000),
                    or(divProxyFilter(this, 3), divProxyFilter(this, 5))),
    ...
    public void problemTwo() {
        assertEqual(Integer.valueOf(4613732),
            reduce(
                select(fib(4000000), divProxyFilter(this, 2)),
                sumProxyFunctor2(this)),
    ...
    public void problemFour() {
        assertEqual(Integer.valueOf(906609),
            head(
                reverse(
                    sort(
                        select(
                            produce(range(100, 1000), range(100, 1000), multiplyProxyFunctor2(this)),
